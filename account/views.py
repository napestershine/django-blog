...
class RegisterView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            text_content = '''
                                If you see this message, it means that your mail server does not provide HTML
                                link function, please contact the administrator.
                           '''
            html_content = '''
...
class ActivateView(View):
    def get(self, request, *args, **kwargs):
        ...
        if user is not None and account_activation_token.check_token(user, token):
            ...
            return render(request, 'account/notice_template.html', locals())
